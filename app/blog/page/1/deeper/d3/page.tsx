...
export const metadata: Metadata = {
  title: "Deep Chain d3 | Broken Fixture Co",
};

// Link-depth burial chain, hop 3 of 8 (home -> /blog/page/1 -> deeper -> d3 -> ... -> d8 ->
