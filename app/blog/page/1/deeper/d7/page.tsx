...
export const metadata: Metadata = {
  title: "Deep Chain d7 | Broken Fixture Co",
};

// Link-depth burial chain, hop 7 of 8 (home -> /blog/page/1 -> deeper -> d3 -> ... -> d8 ->
