...
export const metadata: Metadata = {
  title: "Deep Chain d4 | Broken Fixture Co",
};

// Link-depth burial chain, hop 4 of 8 (home -> /blog/page/1 -> deeper -> d3 -> ... -> d8 ->
